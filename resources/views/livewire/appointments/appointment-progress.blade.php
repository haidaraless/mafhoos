<div class="grid grid-cols-1 content-start border-l border-dashed border-neutral-300 dark:border-white/10 bg-white dark:bg-white/5">
    @if($appointment)
        ...
        <div class="grid grid-cols-1">
            ...
            <div class="col-span-1 flex items-center gap-2 px-6 py-1 {{ $appointment->scheduled_at ? 'text-blue-700' : 'text-neutral-500' }} border-t border-neutral-300 dark:border-white/10">
                @svg('phosphor-number-circle-four', 'size-4')
                <p class="text-sm font-medium">
                    {{ __('Pay Inspection Fee') }}
                </p>
            </div>
        </div>
