<div class="grid grid-cols-1 border border-neutral-200 dark:border-white/10 rounded-3xl overflow-hidden bg-white dark:bg-neutral-900">
    <div class="col-span-1 flex flex-col gap-6 p-3 md:p-6 bg-white dark:bg-neutral-900 border-b border-neutral-200 dark:border-white/10">
    ...
    @if($vehicles->count() > 0)
        ...
        <div class="py-6 border-t border-neutral-200 dark:border-white/10 bg-white dark:bg-transparent">
            <div class="text-center">
                <p class="text-neutral-600 dark:text-white/70 mb-4">Don't see your vehicle?</p>
                <a href="{{ route('vehicles.create') }}" class="inline-flex items-center px-4 py-2 bg-white dark:bg-neutral-900 hover:bg-neutral-900 dark:hover:bg-white/10 border border-neutral-900 dark:border-white/20 text-neutral-800 dark:text-white hover:text-white text-sm font-medium rounded-full transition-colors duration-200">
    ...
    @else
        <div class="text-center p-8 border border-neutral-200 dark:border-white/10 rounded-2xl bg-white dark:bg-neutral-900">
