    ...
    <div class="grid grid-cols-1 overflow-hidden border border-neutral-300 rounded-2xl">
        <div class="col-span-1 flex items-center justify-between gap-20 p-6 bg-neutral-50 border-b border-neutral-300">
            <div class="flex flex-col">
                <h1 class="text-3xl text-neutral-800 font-bold">{{ __('Create your new mafhoos account') }}</h1>
        ...
        <form method="POST" wire:submit="register" class="grid grid-cols-1">
            <label for="name" class="flex items-center gap-4 px-6 py-4 text-neutral-800 hover:text-green-500 bg-white hover:bg-white transition-all ease-in-out duration-300 cursor-pointer">
                ...
                <div class="flex flex-col w-full">
                    ...
                    <input type="text" name="name" id="name" wire:model="name" autofocus required placeholder="Haidar Alessa" class="w-full text-2xl text-neutral-800 placeholder:text-neutral-400 font-semibold focus:outline-none focus:ring-0 focus:border-none"/>
                    @error('name')
            ...
            <label for="email" class="flex items-center gap-4 px-6 py-4 text-neutral-800 hover:text-green-500 @error('email') text-rose-500 @enderror bg-white hover:bg-white border-t border-neutral-300 transition-all ease-in-out duration-300 cursor-pointer">
                ...
                <div class="flex flex-col w-full">
                    ...
                    <input type="email" name="email" id="email" wire:model="email" required placeholder="example@example.com" class="w-full text-2xl text-neutral-800 placeholder:text-neutral-400 font-semibold focus:outline-none focus:ring-0 focus:border-none"/>
                    @error('email')
                        <span class="mt-0.5 text-xs text-rose-500">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <label for="password" class="flex items-center gap-4 px-6 py-4 text-neutral-800 hover:text-green-500 error:text-rose-500 bg-white hover:bg-white border-t border-neutral-300 transition-all ease-in-out duration-300 cursor-pointer">
                ...
                <div class="flex flex-col w-full">
                    ...
                    <input type="password" name="password" id="password" wire:model="password" required placeholder="********" class="w-full text-2xl text-neutral-800 placeholder:text-neutral-400 font-semibold focus:outline-none focus:ring-0 focus:border-none"/>
                    @error('password')
                        <span class="mt-0.5 text-xs text-rose-500">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <label for="password_confirmation" class="flex items-center gap-4 px-6 py-4 text-neutral-800 hover:text-green-500 bg-white hover:bg-white border-t border-neutral-300 transition-all ease-in-out duration-300 cursor-pointer">
                ...
                <div class="flex flex-col w-full">
                    ...
                    <input type="password" name="password_confirmation" id="password_confirmation" wire:model="password_confirmation" required placeholder="********" class="w-full text-2xl text-neutral-800 placeholder:text-neutral-400 font-semibold focus:outline-none focus:ring-0 focus:border-none"/>
            ...
            <button type="submit" class="flex items-center gap-16 px-6 py-4 min-h-24 text-sm text-white bg-neutral-800 hover:bg-neutral-900 transition-all ease-in-out duration-300 cursor-pointer">
                <div class="flex flex-col w-full text-left">
                    ...
                    <span wire:loading.remove wire:target="register" class="text-neutral-400">Create your new mafhoos account</span>
                    <span wire:loading wire:target="register" class="text-neutral-400">Creating...</span>
                </div>
