        ...
        <div class="grid grid-cols-1 gap-8 content-start p-8">
            ...
            <div class="flex flex-col gap-2">
                <div class="flex items-center justify-between gap-2">
                    ...
                    @svg('phosphor-file-text', 'size-8 text-orange-500')
                </div>
    ...
    <div class="col-span-3 grid grid-cols-1 content-start">
        ...
        @if($quotationRequests->count() > 0)
            @foreach($quotationRequests as $request)
                <div class="col-span-1 flex items-center px-4 min-h-16 border-b border-neutral-200 dark:border-neutral-700 last:border-b-0">
