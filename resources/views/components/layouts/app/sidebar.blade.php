...
<body class="min-h-screen bg-alabaster dark:bg-zinc-800">
            ...
            <flux:navlist.group :heading="__('Platform')" class="grid">
                ...
                @if (Auth::user()->currentAccount->isProvider())
                    <flux:navlist.item icon="calendar" :href="route('appointments.index')"
                        :current="request()->routeIs('appointments.index')" wire:navigate>{{ __('Appointments') }}
                    </flux:navlist.item>
                    <flux:navlist.item icon="clock" :href="route('providers.available-times.manage')"
                        ...
                        {{ __('Available Times') }}</flux:navlist.item>
                @endif
            </flux:navlist.group>
        </flux:navlist>
